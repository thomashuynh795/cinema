...
<html lang="zxx">
    <head>
        <meta charset="UTF-8">
    	<link rel="stylesheet" type="text/css" href="../css/0_home.css"/>
    ...
    <body class="c1">
        <header class="c2">
            ...
            <nav id="menu">
                <ul>
                    <li class="color-2f90f7"><a href="0_home.php">home</a></li>
            ...
            <div class="c4">
                ...
                <form class="searchbox sbx-medium">
                    <div role="search" class="sbx-medium__wrapper">
                        <input type="search" name="search" placeholder="search" autocomplete="off" required="required" class="sbx-medium__input">
        ...
        <script src="../js/0_home.js"></script>
    </body>
</html>