...
<html lang="zxx">
    <head>
        <meta charset="UTF-8">
    	<link rel="stylesheet" type="text/css" href="../css/5_subscriptions.css"/>
    ...
    <body>
        <header class="c2">
            ...
            <nav id="menu">
                <ul>
                    ...
                    <li class="color-2f90f7"><a href="5_subscriptions.php">subscriptions</a></li>
        ...
        <?php
            ...
            f22($array, f21(f20($db)));
        // $array = f16($db);
        // f17($db, $array);
        //     f16($db);
        //     if(isset($_GET["search"])) {
        //         f11($db, "title, director, duration, release_date", $_GET["search"]);
        //     }
        ?>
        </div>
        <script src="../js/5_subscriptions.js"></script>
    </body>
</html>