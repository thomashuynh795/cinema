...
<html lang='zxx'>
    <head>
        <meta charset='UTF-8'>
    	<link rel='stylesheet' type='text/css' href='../css/7_history.css'/>
    ...
    <body>
        <header class='c2'>
            ...
            <nav id='menu'>
                <ul>
                    ...
                    <li class='color-2f90f7'><a href='7_history.php'>history</a></li>
                </ul>
            </nav>
            <div class='c4'>
        ...
        <div class='c5'>
            <form method='POST' action='7_history.php'>
                <div>user id</div>
                <input name='user-id' type='text'>
                <input value='show history' type='submit' name='show-history'></input>
            </form>
        </div>
        <?php
            if($_POST) {
                if($_POST['user-id']) {
                    ...
                    f22($array, show_history($db, $id_user));
                }
            }
        ?>
        <script src='../js/7_history.js'></script>
    </body>
</html>