...
<html lang="zxx">
    <head>
        <meta charset="UTF-8">
    	<link rel="stylesheet" type="text/css" href="../css/2_genres.css"/>
    ...
    <body>
        <header class="c2">
            ...
            <nav id="menu">
                <ul>
                    ...
                    <li class="color-2f90f7"><a href="2_genres.php">genres</a></li>
            ...
            <div class="c4">
                ...
                <form class="searchbox sbx-medium">
                    <div role="search" class="sbx-medium__wrapper">
                        <input type="search" name="search" placeholder="not available" autocomplete="off" required="required" class="sbx-medium__input">
        ...
        <form method="GET" action="2_genres.php" id="id1">
            <select name="genre" class="c1" id="id2">
            ...
            <?php
                if(isset($_GET["genre"])) {
                    f6($db, "title, director, duration, release_date", $_GET["genre"]);
                }
            ?>
        <script src="../js/2_genres.js"></script>
    </body>
</html>