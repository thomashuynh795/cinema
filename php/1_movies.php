...
<html lang='zxx'>
    <head>
        <meta charset='UTF-8'>
    	<link rel='stylesheet' type='text/css' href='../css/1_movies.css'/>
    ...
    <body id='id1'>
        <header id='id2' class='c2'>
            <div class='c3'>cinema</div>
            <nav id='menu'>
                <ul>
                    <li><a href='0_home.php'>home</a></li>
                    <li class='color-2f90f7'><a href='1_movies.php'>movies</a></li>
        ...
        <script src='../js/1_movies.js'></script>
    </body>
</html>