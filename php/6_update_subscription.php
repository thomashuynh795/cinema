...
<html lang="zxx">
    <head>
        <meta charset="UTF-8">
    	<link rel="stylesheet" type="text/css" href="../css/6_update_subscription.css"/>
    ...
    <body>
        <header class="c2">
            ...
            <nav id="menu">
                <ul>
                    ...
                    <li><a href="3_distributors.php">distributors</a></li>
                    <li><a href="4_members.php">members</a></li>
                    <li><a href="5_subscriptions.php">subscriptions</a></li>
                    <li class="color-2f90f7"><a href="6_update_subscription.php">update subscription</a></li>
            ...
            <div class="c4">
                ...
                <form method="GET" class="searchbox sbx-medium" id="id3">
                    <div role="search" class="sbx-medium__wrapper">
                        <input type="search" name="search" placeholder="not available" autocomplete="off" required="required" class="sbx-medium__input" id="id4">
        ...
        <div class="c5">
            <form method="POST" action="6_update_subscription.php">
                <div>user id</div>
                <input name="user-id" type="text">
                <div>subscription</div>
                    <select name="id-subscription" id="">
                ...
                <input value="modify" type="submit" name="modify"></input>
            </form>
        </div>
        <?php
            if($_POST) {
                if($_POST["user-id"]) {
                    ...
                    $id_subscription = $_POST["id-subscription"];
                    modify_subscription($db, $id_user, $id_subscription);
                }
            }
        ?>
        <script src="../js/6_update_subscription.js"></script>
    </body>
</html>